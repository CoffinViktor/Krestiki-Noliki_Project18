...
QUESTION questionArray[30] = {
	...
	{21,"Как долго длилась Столетняя война?", 2,{"Мальта","Ватикан","Монако","Мальдивы"}},
	{22,"Какое животное находится под защитой закона в Риме?", 3,{"Крысы","Курицы","Кошки","Львы"}},
	{23,"Какое животное находится под защитой закона в Риме?", 1,{"Бегемот","Аллигатор","Лев","Крокодил"}},
